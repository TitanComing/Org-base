...
function generateChannelArtifacts() {
  ...
  echo "#################################################################"
  $CONFIGTXGEN -profile ThreeOrgsChannel -outputAnchorPeersUpdate ./channel/Org1MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org1MSP
  if [ "$?" -ne 0 ]; then
  ...
  echo "#################################################################"
  $CONFIGTXGEN -profile ThreeOrgsChannel -outputAnchorPeersUpdate ./channel/Org2MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org2MSP
  if [ "$?" -ne 0 ]; then
  ...
  echo "#################################################################"
  $CONFIGTXGEN -profile ThreeOrgsChannel -outputAnchorPeersUpdate ./channel/Org3MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org3MSP
  if [ "$?" -ne 0 ]; then
